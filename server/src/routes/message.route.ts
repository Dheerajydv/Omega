...
import { sendMessage, getMessages, sendImage } from "../controllers/message.controller";
...
router.post("/send-image/:id", verifyUserAutherization, upload.single("image"), sendImage);
